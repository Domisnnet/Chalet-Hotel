...
| :--- | :--- | :--- |
| **Estrutura** | ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) | Organização em blocos (`divs`) para topo, menus e áreas de conteúdo. |
| **Estilo** | ![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white) | Implementação de layouts em colunas e estilização de navegação. |
| **UI/UX** | ![Design](https://img.shields.io/badge/Visual-Clean-lightgrey?style=flat-square) | Tipografia e paleta de cores voltadas para o setor de hotelaria. |
...
[![Repositório](https://img.shields.io/badge/Repositório-Domisnnet%2Fchale--hotel-1DB954?style=for-the-badge&logo=github)](https://github.com/Domisnnet/chale-hotel)
